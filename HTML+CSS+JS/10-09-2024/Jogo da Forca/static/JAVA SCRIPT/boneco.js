function desenharBoneco(tentativasRestantes) {
    ...
    travessaSuperior.style.height = "111px";
    travessaSuperior.style.backgroundColor = corPalo;
    ...
    if (tentativasRestantes <= 5) {
        ...
        cabeca.style.border = `2px solid ${corCabeca}`;
    ...
    if (tentativasRestantes <= 3) {
        ...
        bracoEsquerdo.style.backgroundColor = corBracos;
        forca.appendChild(bracoEsquerdo);
    }

    // Adiciona o braço direito se restam 2 ou menos tentativas
    if (tentativasRestantes <= 2) {
        ...
        bracoDireito.style.backgroundColor = corBracos;
    ...
    if (tentativasRestantes <= 1) {
        ...
        pernaEsquerda.style.backgroundColor = corPernas;
        forca.appendChild(pernaEsquerda);
    }

    // Adiciona a perna direita se restam 0 tentativas
    if (tentativasRestantes <= 0) {
        ...
        pernaDireita.style.backgroundColor = corPernas;
